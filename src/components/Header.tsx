  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <div className='flex justify-center gap-3 mt-8 flex-wrap items-center'>
        <Link href="/getstarted" className={`bg-[#8247ff] text-center text-white rounded-2xl py-3 px-11 text-lg font-semibold hover:ring-8 hover:ring-zinc-200`} onMouseEnter={handleHover}
          onMouseLeave={handleHover}>{hovered ? `${"Get Started 🚀"}` : 'Get Started'}</Link>
        <Link href="/watchdemo" className='bg-white text-black rounded-2xl py-3 px-12 text-lg font-semibold border border-gray-300 hover:border-gray-500 text-center'>Watch Demo</Link>
      </div>
      <div>
