    ...
    return (
        <div className="flex flex-col justify-center items-center bg-white pb-32 pt-16">
            ...
            <div className='flex gap-5 mt-10 flex-wrap justify-center'>
                <div className='max-w-sm border border-gray-200 rounded-3xl bg-[#ededfa] p-16 flex flex-col justify-between items-center'>
                    ...
                    <Link href="/buytemplate" className='bg-white text-black rounded-2xl py-3 px-8 text-lg font-semibold border border-gray-300 hover:border-gray-500 text-center'>Get started</Link>
                </div>
                <div className='max-w-sm border border-gray-200 rounded-3xl bg-[#1c1c1c] p-16 flex flex-col justify-between items-center'>
                    <div className='flex justify-start flex-col'>
